...
namespace Ktra
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            var nhom = nhomService.Getnhomdb();
            if (nhom == null)
            {
            ...
            else
            {
                ...
                listlienlac = lienlacService.getlisstdb(temp);
        ...
        private void xoaLienLac_Click(object sender, EventArgs e)
        {
            ...
            if (lienlac != null)
            {
                ...
                {
                    //Viết code xóa dữ liệu ở đây --> Bài tập về nhà ngày 12/10/2019
                    lienlacService.Removedb(lienlac);
        ...
        private void themLienLac_Click(object sender, EventArgs e)
        {
            ...
            if (addlienlac.DialogResult == DialogResult.OK)
            {
               var listlienlac = lienlacService.getlisstdb(nhom.id);
                listlienlacvariable = listlienlac;
                dataGridView2.AutoGenerateColumns = false;
                bindingSourcelienlac.DataSource = listlienlac;
                dataGridView2.DataSource = bindingSourcelienlac;
